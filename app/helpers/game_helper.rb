module GameHelper
    ...
    embed('/game/js/lib/three.js/build/Three.js')
    ...
    embed('/game/js/ChuClone/components/PortalComponent.js')
    ...
    embed('/game/js/ChuClone/components/effect/MotionStreakComponent.js')
    ...
    embed('/game/js/ChuClone/components/player/PortalGunComponent.js')

    embed('/game/js/ChuClone/components/AntiPhysicsVelocityLimitComponent.js')
