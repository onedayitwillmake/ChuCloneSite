...
(function(){
	...
	RealtimeMultiplayerGame.ClientNetChannel.prototype = {
		...
		setupSocketIO: function() {
		    this.socketio = new io.Socket( this.host, {port: this.port, transports:['websocket', 'htmlfile', 'xhr-multipart', 'xhr-polling', 'jsonp-polling'], reconnect: false, rememberTransport: false});
